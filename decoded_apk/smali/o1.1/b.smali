...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, LC1/h;-><init>(Landroid/content/Context;)V

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lo1/b;->O:Ljava/util/ArrayList;
...
.method public final onMeasure(II)V
    ...
    invoke-virtual {p0}, LC1/h;->getMenu()Lj/l;
    ...
    iget-object v2, p0, Lo1/b;->O:Ljava/util/ArrayList;
    ...
    :goto_1
    iget v7, p0, Lo1/b;->L:I

    const/16 v9, 0x8

    if-eqz v5, :cond_8

    iget-boolean v5, p0, Lo1/b;->N:Z

    if-eqz v5, :cond_8

    invoke-virtual {p0}, LC1/h;->getSelectedItemPosition()I
