...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {v0, p2, v1, v2}, LA1/k;->v(Landroid/content/Context;Landroid/util/AttributeSet;[II)LA1/k;

    move-result-object p2

    const/4 v0, 0x5

    invoke-virtual {p2, v0}, LA1/k;->l(I)Landroid/graphics/drawable/Drawable;
...
.method public final c(Lj/n;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->c:Lj/n;
    ...
    iget-object v0, p1, Lj/n;->n:Lj/l;

    invoke-virtual {v0}, Lj/l;->o()Z
    ...
    invoke-virtual {v0}, Lj/l;->n()Z

    move-result v0

    if-eqz v0, :cond_1

    iget-char v0, p1, Lj/n;->j:C

    goto :goto_1

    :cond_1
    iget-char v0, p1, Lj/n;->h:C
    ...
    :goto_2
    iget-object v4, p1, Lj/n;->n:Lj/l;

    invoke-virtual {v4}, Lj/l;->n()Z

    if-eqz v0, :cond_5

    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->c:Lj/n;

    iget-object v4, v0, Lj/n;->n:Lj/l;

    invoke-virtual {v4}, Lj/l;->o()Z
    ...
    iget-char v0, v0, Lj/n;->j:C

    goto :goto_3

    :cond_3
    iget-char v0, v0, Lj/n;->h:C
    ...
    iget-object v4, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->c:Lj/n;

    iget-object v5, v4, Lj/n;->n:Lj/l;

    invoke-virtual {v5}, Lj/l;->n()Z

    move-result v5

    if-eqz v5, :cond_6

    iget-char v5, v4, Lj/n;->j:C

    goto :goto_6

    :cond_6
    iget-char v5, v4, Lj/n;->h:C
    ...
    :cond_7
    iget-object v6, v4, Lj/n;->n:Lj/l;

    iget-object v7, v6, Lj/l;->a:Landroid/content/Context;
    ...
    iget-object v9, v6, Lj/l;->a:Landroid/content/Context;
    ...
    invoke-static {v4, v9, v6, v8}, Lj/n;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v4, v3, v6, v8}, Lj/n;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v4, v6, v3, v8}, Lj/n;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v4, v1, v3, v8}, Lj/n;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    iget-object p1, p1, Lj/n;->q:Ljava/lang/CharSequence;
...
.method public getItemData()Lj/n;
    ...
    iget-object p0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->c:Lj/n;
