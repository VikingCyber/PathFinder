...
.method public static A(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, v0}, Lc0/a;->n(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public static T(Landroid/content/res/Configuration;Landroid/graphics/Typeface;)Landroid/graphics/Typeface;
    ...
    invoke-static {v0, p0, v1}, LG0/f;->l(III)I
...
.method public static X(Landroid/os/Parcel;I)Z
    ...
    invoke-static {p0, p1, v0}, LG0/f;->p0(Landroid/os/Parcel;II)V
...
.method public static Y(Landroid/os/Parcel;I)Landroid/os/IBinder;
    ...
    invoke-static {p0, p1}, LG0/f;->b0(Landroid/os/Parcel;I)I
...
.method public static a0(Landroid/os/Parcel;I)J
    .locals 1
...
.method public static d(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    ...
    sget-object v0, Li2/a;->a:Ljava/lang/Integer;
    ...
    :cond_0
    sget-object v0, Lh2/a;->a:Ljava/lang/reflect/Method;
...
.method public static d0(Landroid/content/Context;ILandroid/view/animation/Interpolator;)Landroid/animation/TimeInterpolator;
    .locals 5
    ...
    invoke-static {p1, v1}, LG0/f;->P(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p1, v4}, LG0/f;->P(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p1, p0}, LG0/f;->F(I[Ljava/lang/String;)F

    move-result p1

    invoke-static {v2, p0}, LG0/f;->F(I[Ljava/lang/String;)F

    move-result v0

    const/4 v1, 0x2

    invoke-static {v1, p0}, LG0/f;->F(I[Ljava/lang/String;)F

    move-result v1

    invoke-static {p2, p0}, LG0/f;->F(I[Ljava/lang/String;)F
    ...
    invoke-static {p0}, LY0/a;->u(Ljava/lang/String;)[LE/f;

    move-result-object p2

    :try_start_0
    invoke-static {p2, p1}, LE/f;->b([LE/f;Landroid/graphics/Path;)V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0

    invoke-static {p1}, LO/a;->c(Landroid/graphics/Path;)Landroid/view/animation/Interpolator;
...
.method public static e(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0, p1, p2}, LG0/f;->f(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z

    move-result v0

    invoke-static {p0, p1, p3}, LG0/f;->f(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_5
    invoke-static {p0, p1, p2}, LG0/f;->S(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
...
.method public static g0(Landroid/view/View;LH1/g;)V
    .locals 3

    iget-object v0, p1, LH1/g;->c:LH1/f;

    iget-object v0, v0, LH1/f;->b:Lx1/a;
    ...
    :cond_0
    iget-object p0, p1, LH1/g;->c:LH1/f;

    iget v1, p0, LH1/f;->l:F
...
.method public static h0(Lcom/google/android/gms/common/api/Status;Ljava/lang/Boolean;Lh1/f;)V
    .locals 1
    ...
    invoke-virtual {p2, p1}, Lh1/f;->a(Ljava/lang/Boolean;)V

    return-void

    :cond_0
    iget-object p1, p0, Lcom/google/android/gms/common/api/Status;->f:Landroid/app/PendingIntent;

    if-eqz p1, :cond_1

    new-instance p1, LQ0/l;

    invoke-direct {p1, p0}, LQ0/f;-><init>(Lcom/google/android/gms/common/api/Status;)V
    ...
    :goto_0
    iget-object p0, p2, Lh1/f;->a:Lh1/k;

    invoke-virtual {p0, p1}, Lh1/k;->c(Ljava/lang/Exception;)V
...
.method public static k(Landroid/content/Context;Ljava/lang/String;)I
    ...
    :cond_0
    invoke-static {p1}, LB/b;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, LB/c;->c(Landroid/content/Context;)Landroid/app/AppOpsManager;
    ...
    invoke-static {v3, p1, v4, v2}, LB/c;->a(Landroid/app/AppOpsManager;Ljava/lang/String;ILjava/lang/String;)I
    ...
    :cond_5
    invoke-static {p0}, LB/c;->b(Landroid/content/Context;)Ljava/lang/String;

    move-result-object p0

    invoke-static {v3, p1, v1, p0}, LB/c;->a(Landroid/app/AppOpsManager;Ljava/lang/String;ILjava/lang/String;)I
    ...
    invoke-static {p0, v1}, LB/b;->a(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/app/AppOpsManager;

    invoke-static {p0, p1, v2}, LB/b;->c(Landroid/app/AppOpsManager;Ljava/lang/String;Ljava/lang/String;)I
...
.method public static final k0(LB2/t;LB2/t;Ln2/p;)Ljava/lang/Object;
    .locals 1
    ...
    invoke-direct {p2, p1, v0}, Lx2/n;-><init>(Ljava/lang/Throwable;Z)V
...
.method public static m0(Landroid/content/Context;I)I
    .locals 1
...
.method public static n(Landroid/content/Context;)LU/q;
    .locals 8
    ...
    invoke-static {v0, v1}, LY0/a;->n(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v1, v3, v5, v0}, LH2/y;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
    :try_end_0
    ...
    invoke-direct {v0, p0, v2}, LU/p;-><init>(Landroid/content/Context;LH2/y;)V

    invoke-direct {v4, v0}, LU/f;-><init>(LU/h;)V
...
.method public static o0(Landroid/os/Parcel;)I
    .locals 5
    ...
    invoke-static {p0, v0}, LG0/f;->b0(Landroid/os/Parcel;I)I
    ...
    invoke-static {v2, v1, v3, v4}, LC/c;->f(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-direct {v0, v1, p0}, LF2/f;-><init>(Ljava/lang/String;Landroid/os/Parcel;)V
    ...
    invoke-direct {v1, v0, p0}, LF2/f;-><init>(Ljava/lang/String;Landroid/os/Parcel;)V

    throw v1
.end method

.method public static p(I)LY0/a;
    .locals 1
...
.method public static p0(Landroid/os/Parcel;II)V
    ...
    invoke-static {v2, v1, p1}, LC/c;->j(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    invoke-direct {v0, p1, p0}, LF2/f;-><init>(Ljava/lang/String;Landroid/os/Parcel;)V

    throw v0
.end method

.method public static final q(Ljava/lang/Throwable;)La2/g;
    .locals 1
    ...
    invoke-direct {v0, p0}, La2/g;-><init>(Ljava/lang/Throwable;)V
...
.method public static final x(LG0/p;)LG0/j;
    .locals 2
...
.method public static y(Landroid/content/Context;LA1/k;I)Landroid/content/res/ColorStateList;
    .locals 2
    ...
    :cond_0
    invoke-virtual {p1, p2}, LA1/k;->k(I)Landroid/content/res/ColorStateList;
...
.method public g(Landroid/content/Context;Landroid/os/Looper;LS0/e;Ljava/lang/Object;LQ0/i;LQ0/j;)LQ0/c;
    ...
    invoke-virtual/range {p0 .. p6}, LG0/f;->h(Landroid/content/Context;Landroid/os/Looper;LS0/e;Ljava/lang/Object;LQ0/i;LQ0/j;)LQ0/c;
...
.method public abstract i0(Landroid/view/View;F)Z
.end method
